...
export default function SearchBar({ data }: InputData) {
  ...
  return (
    <form
      ...
      className="max-w-xl w-full h-12 md:h-14 mt-6 flex items-center bg-white border border-gray-300 rounded-full focus-within:border-purple-700 transition-colors duration-200"
    >
