...
export default function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between px-4 md:px-14 py-4 border border-gray-200">
      <Link to="/" className="flex items-center gap-2">
        <img src={assets.logo} alt="Logo" className="w-8 md:w-9" />
        <p className="text-purple-700 text-lg md:text-xl font-bold">Ascend</p>
      </Link>
