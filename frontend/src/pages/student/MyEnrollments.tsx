...
export default function MyEnrollments() {
  ...
  return (
    <>
      <div className="md:px-36 md:py-28 px-8 py-10">
        ...
        <table className="table-fixed md:table-auto w-full overflow-hidden border mt-10">
          ...
          <tbody className="text-gray-700">
            {!enrolledCourses.length ? (
              <tr className="border border-gray-500/20">
                <td colSpan={4} className="py-12 text-center">
                  ...
                  <Link
                    to="/course-list"
                    className="inline-block rounded-md px-4 py-2 text-sm font-medium text-purple-600 bg-purple-100/60 hover:bg-purple-200/70 transition-colors"
                  >
                    Browse courses
                  </Link>
                </td>
